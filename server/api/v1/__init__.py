from server.api.v1.users import users_bp
from server.api.v1.projects import projects_bp
from server.api.v1.module_templates import module_templates_bp
from server.api.v1.courses import courses_bp
